    ...
    private void loadJobFields() {
        if (jobFieldRepository.count() == 0) {
            List<JobField> fields = Arrays.asList(
                    ...
                    JobField.builder().name("Phi Lợi Nhuận và Dịch Vụ Xã Hội").slug("phi-loi-nhuan-va-dich-vu-xa-hoi")
                            .build(),
                    JobField.builder().name("Sản Xuất và Kỹ Thuật").slug("san-xuat-va-ky-thuat").build(),
                    JobField.builder().name("Truyền Thông, Quảng Cáo và Giải Trí")
                            .slug("truyen-thong-quang-cao-va-giai-tri").build(),
                    ...
                    JobField.builder().name("Vận Tải, Logistics và Kho Hàng").slug("van-tai-logistics-va-kho-hang")
                            .build(),
                    ...
                    JobField.builder().name("Thuê Ngoài Phát Triển Phần Mềm").slug("thue-ngoai-phat-trien-phan-mem")
                            .build(),
                    JobField.builder().name("Sản Phẩm Phần Mềm và Dịch Vụ Web").slug("san-pham-phan-mem-va-dich-vu-web")
                            .build(),
                    ...
                    JobField.builder().name("Nghiên cứu & Phát triển Công nghệ Mới")
                            .slug("nghien-cuu-phat-trien-cong-nghe-moi").build(),
                    JobField.builder().name("Phần mềm và Dịch vụ Trí tuệ Nhân tạo")
                            .slug("phan-mem-va-dich-vu-tri-tue-nhan-tao").build());
    ...
    private void loadSpecializations() {
        if (specializationRepository.count() == 0) {
            List<Specialization> specializations = Arrays.asList(
                    ...
                    Specialization.builder().category("IT Executive and Management")
                            .name("Cấp điều hành (CTO, CIO, CISO, CDO)").slug("cap-dieu-hanh-cto-cio-ciso-cdo").build(),
                    Specialization.builder().category("IT Executive and Management").name("Phó Chủ tịch / Giám đốc")
                            .slug("pho-chu-tich-giam-doc").build(),
                    Specialization.builder().category("IT Executive and Management").name("Quản lý").slug("quan-ly")
                            .build(),

                    // Web Application Development
                    Specialization.builder().category("Web Application Development").name("Lập trình viên Backend")
                            .slug("lap-trinh-vien-backend").build(),
                    Specialization.builder().category("Web Application Development").name("Lập trình viên Frontend")
                            .slug("lap-trinh-vien-frontend").build(),
                    Specialization.builder().category("Web Application Development").name("Lập trình viên Fullstack")
                            .slug("lap-trinh-vien-fullstack").build(),

                    // Mobile Application Development
                    Specialization.builder().category("Mobile Application Development")
                            .name("Lập trình viên Ứng dụng Di động").slug("lap-trinh-vien-ung-dung-di-dong").build(),

                    // Core / Enterprise Systems Development
                    Specialization.builder().category("Core / Enterprise Systems Development").name("Kỹ sư RPA")
                            .slug("ky-su-rpa").build(),
                    Specialization.builder().category("Core / Enterprise Systems Development")
                            .name("Lập trình viên ERP").slug("lap-trinh-vien-erp").build(),
                    Specialization.builder().category("Core / Enterprise Systems Development")
                            .name("Lập trình viên Hệ thống Integration & Legacy")
                            .slug("lap-trinh-vien-he-thong-integration").build(),

                    // Low-Code / No-Code Development
                    Specialization.builder().category("Low-Code / No-Code Development")
                            .name("Lập trình viên Low-Code/No-Code").slug("lap-trinh-vien-low-code-no-code").build(),

                    // Technical Architecture
                    Specialization.builder().category("Technical Architecture").name("Kiến trúc sư Doanh nghiệp")
                            .slug("kien-truc-su-doanh-nghiep").build(),
                    Specialization.builder().category("Technical Architecture").name("Kiến trúc sư Giải pháp")
                            .slug("kien-truc-su-giai-phap").build(),
                    Specialization.builder().category("Technical Architecture").name("Kiến trúc sư Phần mềm")
                            .slug("kien-truc-su-phan-mem").build(),

                    // Blockchain Development
                    Specialization.builder().category("Blockchain Development").name("Kiến trúc sư Blockchain")
                            .slug("kien-truc-su-blockchain").build(),
                    Specialization.builder().category("Blockchain Development").name("Lập trình viên Blockchain")
                            .slug("lap-trinh-vien-blockchain").build(),
                    Specialization.builder().category("Blockchain Development").name("Lập trình viên Smart Contract")
                            .slug("lap-trinh-vien-smart-contract").build(),

                    // Game Development
                    Specialization.builder().category("Game Development").name("Lập trình viên Game")
                            .slug("lap-trinh-vien-game").build(),
                    Specialization.builder().category("Game Development").name("Thiết kế Game").slug("thiet-ke-game")
                            .build(),

                    // Software Testing & Quality Assurance
                    Specialization.builder().category("Software Testing & QA").name("Kiểm thử thủ công")
                            .slug("kiem-thu-thu-cong").build(),
                    Specialization.builder().category("Software Testing & QA").name("Kiểm thử tự động")
                            .slug("kiem-thu-tu-dong").build(),

                    // Data Engineering
                    Specialization.builder().category("Data Engineering").name("Kỹ sư Dữ liệu").slug("ky-su-du-lieu")
                            .build(),
                    Specialization.builder().category("Data Engineering").name("Kỹ sư Cơ sở dữ liệu")
                            .slug("ky-su-co-so-du-lieu").build(),

                    // Data Science & AI
                    Specialization.builder().category("Data Science & AI").name("Data Scientist").slug("data-scientist")
                            .build(),
                    Specialization.builder().category("Data Science & AI").name("Kỹ sư AI / Machine Learning")
                            .slug("ky-su-ai-machine-learning").build(),

                    // Cloud Computing
                    Specialization.builder().category("Cloud Computing").name("Kỹ sư Đám mây").slug("ky-su-dam-may")
                            .build(),
                    ...
                    // Cybersecurity
                    Specialization.builder().category("Cybersecurity").name("Kỹ sư An ninh").slug("ky-su-an-ninh")
                            .build(),

                    // Product Management
                    Specialization.builder().category("Product Management").name("Quản lý sản phẩm")
                            .slug("quan-ly-san-pham").build(),

                    // Design & UX
                    Specialization.builder().category("Design & UX").name("Thiết kế UX/UI").slug("thiet-ke-ux-ui")
                            .build());
