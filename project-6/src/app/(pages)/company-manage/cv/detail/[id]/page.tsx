          ...
          <div className="border border-[#DEDEDE] border-[1px] rounded-[8px] p-[20px]">
            ...
            <div className="mt-[20px] flex flex-col gap-[10px]">
              ...
              <div className="">
                ...
                <div className="mt-[24px] flex gap-[12px] sm:justify-end justify-center">
                  <button className="px-[20px] py-[10px] rounded-[6px] border border-[#ff4d4f] text-[#ff4d4f] font-[600] text-[14px] hover:bg-[#ff4d4f] hover:text-white transition-all">
                    Từ chối
                  </button>
                  <button className="px-[20px] py-[10px] rounded-[6px] bg-[#0D8EFF] text-white font-[600] text-[14px] hover:bg-[#0b79de] transition-all">
                    Chấp nhận
                  </button>
                </div>
              </div>
